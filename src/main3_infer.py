...
class BasicDataset(Dataset):
    ...
    def __getitem__(self, i):
        ...
        # data
        data = read_array(self.dir_data + '/' + idx + '.bin', (1, self.n1, self.n2, self.n3))
...
if __name__ == '__main__':
    ...
    if opts.input is not None:
        ...
        img = read_array(opts.input, (1, 1, n1, n2, n3))
